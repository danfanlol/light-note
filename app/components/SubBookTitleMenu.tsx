...
export default function SubBookTitleMenu({
  subBookId,
  title,
  backHref,
  currentHref,
  ...
  return (
    <>
        ...
        >
          ...
          >
            ...
            <div className="flex justify-end gap-3">
              ...
              <form action={deleteSubBook.bind(null, subBookId, backHref)}>
                <button
                  type="submit"
      ...
      <div className="group relative flex items-center gap-2" ref={containerRef}>
        {renaming ? (
          <form action={renameSubBook.bind(null, subBookId, currentHref)} className="flex items-center gap-2">
            <input
              ref={inputRef}
              name="title"
              value={renameValue}
