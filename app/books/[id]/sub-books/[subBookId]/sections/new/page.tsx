...
import { createSectionForSubBook } from '@/app/actions/sections'

export default async function NewSectionForSubBookPage({
  params,
}: {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      <div className="max-w-lg mx-auto px-6 py-12">
        ...
        <form action={createSectionForSubBook.bind(null, id, subBookId)} className="flex flex-col gap-6">
