...
import { createSubBook } from '@/app/actions/sub-books'

export default async function NewSubBookPage({
  params,
}: {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      <div className="max-w-lg mx-auto px-6 py-12">
        ...
        <form action={createSubBook.bind(null, id)} className="flex flex-col gap-6">
