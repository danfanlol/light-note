...
import { deleteBook, renameBook } from '@/app/actions/books'

export default function BookTitleMenu({ bookId, title }: { bookId: string; title: string }) {
  ...
  return (
    <>
          ...
          >
            ...
            <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-6">
              <span className="font-semibold text-zinc-800 dark:text-zinc-200">
                This will permanently delete &ldquo;{title}&rdquo; and all its sections.
              </span>{' '}
      ...
      <div className="group relative flex items-center gap-2" ref={containerRef}>
        {renaming ? (
          <form action={renameBook.bind(null, bookId)} className="flex items-center gap-2">
            <input
              ref={inputRef}
              name="title"
              value={renameValue}
